...
export const colorClass = (color: string) => {
  ...
  switch (color) {
    case 'black':
      className = 'pokemon_color_black'
      break
    case 'blue':
      className = 'pokemon_color_blue'
      break
    case 'brown':
      className = 'pokemon_color_brown'
      break
    case 'gray':
      className = 'pokemon_color_gray'
      break
    case 'green':
      className = 'pokemon_color_green'
      break
    case 'pink':
      className = 'pokemon_color_pink'
      break
    case 'purple':
      className = 'pokemon_color_purple'
      break
    case 'red':
      className = 'pokemon_color_red'
      break
    case 'white':
      className = 'pokemon_color_white'
      break
    case 'yellow':
      className = 'pokemon_color_yellow'
      break
    default:
      className = 'pokemon_color_white'
      break
